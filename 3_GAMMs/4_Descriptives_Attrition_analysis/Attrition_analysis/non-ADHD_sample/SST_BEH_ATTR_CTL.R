...
library(ggpubr)
library(effectsize)
wd = "~/Desktop/Merv/Study3-Desc/ATTR_S3/ATTR_CONTROLS/SST_CTL"
setwd(wd)
data <- read.csv("~/Desktop/Merv/Study3-Desc/ATTR_S3/exg3_total_wide.csv")
master = data
...
# filter to only CTL sample

data = data %>% filter(DX == 'CONTROL')
...
NROW(which((data$GoRT_1Y_2Y_3Y==TRUE)))
...
p1 = ggline(df, x = "obs", y = "GoRT_1",
            ...
            ylab = "GoRT", xlab = "no. of timepoints completed") + stat_compare_means(method = "anova")
p1
ggsave('GoRT.png',p1)
save(p1,file='GoRT.RData')
...
NROW(which((data$mu.true_1Y_2Y_3Y==TRUE)))
...
p1 = ggline(df, x = "obs", y = "mu.true_1",
            add = c("mean_se", "jitter"),
            order = c("one", "two", "three"),
            ylab = "mu.true", xlab = "no. of timepoints completed") + stat_compare_means(method = "anova")
p1
ggsave('mu.true.png',p1)
save(p1,file='mu.true.RData')
eff=effectsize(m,partial=T)
eff
...
NROW(which((data$sigma.true_1Y_2Y_3Y==TRUE)))
...
p1 = ggline(df, x = "obs", y = "sigma.true_1",
            add = c("mean_se", "jitter"),
            order = c("one", "two", "three"),
            ylab = "sigma.true", xlab = "no. of timepoints completed") + stat_compare_means(method = "anova")
p1
ggsave('sigma.true.png',p1)
save(p1,file='sigma.true.RData')
eff=effectsize(m,partial=T)
eff
...
NROW(which((data$tau.true_1Y_2Y_3Y==TRUE)))
...
p1 = ggline(df, x = "obs", y = "tau.true_1",
            add = c("mean_se", "jitter"),
            order = c("one", "two", "three"),
            ylab = "tau.true", xlab = "no. of timepoints completed") + stat_compare_means(method = "anova")
p1
ggsave('tau.true.png',p1)
save(p1,file='tau.true.RData')
eff=effectsize(m,partial=T)
eff
...
NROW(which((data$mu.false_1Y_2Y_3Y==TRUE)))
...
p1 = ggline(df, x = "obs", y = "mu.false_1",
            add = c("mean_se", "jitter"),
            order = c("one", "two", "three"),
            ylab = "mu.false", xlab = "no. of timepoints completed") + stat_compare_means(method = "anova")
p1
ggsave('mu.false.png',p1)
save(p1,file='mu.false.RData')
eff=effectsize(m,partial=T)
eff
...
NROW(which((data$sigma.false_1Y_2Y_3Y==TRUE)))
...
p1 = ggline(df, x = "obs", y = "sigma.false_1",
            add = c("mean_se", "jitter"),
            order = c("one", "two", "three"),
            ylab = "sigma.false", xlab = "no. of timepoints completed") + stat_compare_means(method = "anova")
p1
ggsave('sigma.false.png',p1)
save(p1,file='sigma.false.RData')
eff=effectsize(m,partial=T)
eff
...
NROW(which((data$tau.false_1Y_2Y_3Y==TRUE)))
...
p1 = ggline(df, x = "obs", y = "tau.false_1",
            add = c("mean_se", "jitter"),
            order = c("one", "two", "three"),
            ylab = "tau.false", xlab = "no. of timepoints completed") + stat_compare_means(method = "anova")
p1
ggsave('tau.false.png',p1)
save(p1,file='tau.false.RData')
eff=effectsize(m,partial=T)
eff
...
NROW(which((data$SSRT_1Y_2Y_3Y==TRUE)))
...
p1 = ggline(df, x = "obs", y = "SSRT_1",
            add = c("mean_se", "jitter"),
            order = c("one", "two", "three"),
            ylab = "SSRT", xlab = "no. of timepoints completed") + stat_compare_means(method = "anova")
p1
ggsave('SSRT.png',p1)
save(p1,file='SSRT.RData')
eff=effectsize(m,partial=T)
eff
...
NROW(which((data$muS_1Y_2Y_3Y==TRUE)))
...
p1 = ggline(df, x = "obs", y = "muS_1",
            add = c("mean_se", "jitter"),
            order = c("one", "two", "three"),
            ylab = "muS", xlab = "no. of timepoints completed") + stat_compare_means(method = "anova")
p1
ggsave('muS.png',p1)
save(p1,file='muS.RData')
eff=effectsize(m,partial=T)
eff
...
NROW(which((data$sigmaS_1Y_2Y_3Y==TRUE)))
...
p1 = ggline(df, x = "obs", y = "sigmaS_1",
            add = c("mean_se", "jitter"),
            order = c("one", "two", "three"),
            ylab = "sigmaS", xlab = "no. of timepoints completed") + stat_compare_means(method = "anova")
p1
ggsave('sigmaS.png',p1)
save(p1,file='sigmaS.RData')
eff=effectsize(m,partial=T)
eff
...
NROW(which((data$tauS_1Y_2Y_3Y==TRUE)))
...
p1 = ggline(df, x = "obs", y = "tauS_1",
            add = c("mean_se", "jitter"),
            order = c("one", "two", "three"),
            ylab = "tauS", xlab = "no. of timepoints completed") + stat_compare_means(method = "anova")
p1
ggsave('tauS.png',p1)
save(p1,file='tauS.RData')
eff=effectsize(m,partial=T)
eff
...
NROW(which((data$prob_GF_1Y_2Y_3Y==TRUE)))
...
p1 = ggline(df, x = "obs", y = "prob_GF_1",
            add = c("mean_se", "jitter"),
            order = c("one", "two", "three"),
            ylab = "prob_GF", xlab = "no. of timepoints completed") + stat_compare_means(method = "anova")
p1
ggsave('prob_GF.png',p1)
save(p1,file='prob_GF.RData')
eff=effectsize(m,partial=T)
eff
...
NROW(which((data$prob_TF_1Y_2Y_3Y==TRUE)))
...
p1 = ggline(df, x = "obs", y = "prob_TF_1",
            add = c("mean_se", "jitter"),
            order = c("one", "two", "three"),
            ylab = "prob_TF", xlab = "no. of timepoints completed") + stat_compare_means(method = "anova")
p1
ggsave('prob_TF.png',p1)
save(p1,file='prob_TF.RData')
eff=effectsize(m,partial=T)
eff
