...
load("/Volumes/Backup Plus/MERV-PROJECT/EXG_7_Plots/samples/exg3_ctl_wave3_summaryparams.RData")
...
SSRT.plot
ggsave('Output/ctl_Wave3_SSRT_subj.jpg')
...
GoRT.plot <- ggplot(GoRT.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
GoRT.plot
ggsave('Output/ctl_Wave3_GoRT_subj.jpg')
...
prob_TF.plot <- ggplot(prob_TF.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
prob_TF.plot
ggsave('Output/ctl_Wave3_prob_TF_subj.jpg')
...
prob_GF.plot <- ggplot(prob_GF.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
prob_GF.plot
ggsave('Output/ctl_Wave3_prob_GF_subj.jpg')
...
MuS.plot <- ggplot(MuS.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
MuS.plot
ggsave('Output/ctl_Wave3_MuS_subj.jpg')
...
sigmaS.plot <- ggplot(sigmaS.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
sigmaS.plot
ggsave('Output/ctl_Wave3_sigmaS_subj.jpg')
...
TauS.plot <- ggplot(MuS.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
TauS.plot
ggsave('Output/ctl_Wave3_TauS_subj.jpg')
...
load("/Volumes/Backup Plus/MERV-PROJECT/EXG_7_Plots/samples/exg3_ctl_wave4_summaryparams.RData")
...
SSRT.plot <- ggplot(SSRT.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
SSRT.plot
ggsave('Output/ctl_Wave4_SSRT_subj.jpg')
...
GoRT.plot <- ggplot(GoRT.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
GoRT.plot
ggsave('Output/ctl_Wave4_GoRT_subj.jpg')
...
prob_TF.plot <- ggplot(prob_TF.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
prob_TF.plot
ggsave('Output/ctl_Wave4_prob_TF_subj.jpg')
...
prob_GF.plot <- ggplot(prob_GF.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
prob_GF.plot
ggsave('Output/ctl_Wave4_prob_GF_subj.jpg')
...
MuS.plot <- ggplot(MuS.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
MuS.plot
ggsave('Output/ctl_Wave4_MuS_subj.jpg')
...
sigmaS.plot <- ggplot(sigmaS.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
sigmaS.plot
ggsave('Output/ctl_Wave4_sigmaS_subj.jpg')
...
TauS.plot <- ggplot(MuS.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
TauS.plot
ggsave('Output/ctl_Wave4_TauS_subj.jpg')
...
load("/Volumes/Backup Plus/MERV-PROJECT/EXG_7_Plots/samples/exg3_ctl_wave5_summaryparams.RData")
...
SSRT.plot <- ggplot(SSRT.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
SSRT.plot
ggsave('Output/ctl_Wave5_SSRT_subj.jpg')
...
GoRT.plot <- ggplot(GoRT.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
GoRT.plot
ggsave('Output/ctl_Wave5_GoRT_subj.jpg')
...
prob_TF.plot <- ggplot(prob_TF.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
prob_TF.plot
ggsave('Output/ctl_Wave5_prob_TF_subj.jpg')
...
prob_GF.plot <- ggplot(prob_GF.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
prob_GF.plot
ggsave('Output/ctl_Wave5_prob_GF_subj.jpg')
...
MuS.plot <- ggplot(MuS.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
MuS.plot
ggsave('Output/ctl_Wave5_MuS_subj.jpg')
...
sigmaS.plot <- ggplot(sigmaS.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
sigmaS.plot
ggsave('Output/ctl_Wave5_sigmaS_subj.jpg')
...
TauS.plot <- ggplot(MuS.long, aes(x=value, colour=Var2)) +
  ...
  theme(legend.position="none")
TauS.plot
ggsave('Output/ctl_Wave5_TauS_subj.jpg')

# save workspace
save.image('Output/ControlPlots.RData')
