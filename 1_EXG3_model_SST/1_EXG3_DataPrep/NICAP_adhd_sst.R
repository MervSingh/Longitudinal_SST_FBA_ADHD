#set wd
setwd("~/Desktop/project/EXG3-prep/adhd/wave3")
#setwd("~/Desktop/project/EXG3-prep/adhd/wave4")
#setwd("~/Desktop/project/EXG3-prep/adhd/wave5")
...
dir.create("./w#_adhd_processed_data") #create a new directory to place all ouput files
save(combined, file = "./w#_adhd_processed_data/w#_adhd_Results_uncleaned.Rdata") #Rdata
write.csv(combined, "./w#_adhd_processed_data/w#_adhd_Results_uncleaned.csv", row.names = F) #csv

#Save the raw input datafile:
dir.create("./w#_adhd_raw_output")
save(input, file = "./w#_adhd_raw_output/w#_adhd_RawData_uncleaned.RData")

save.image("wave#_adhd.Rdata")
...
wave3 <- read.csv("./wave#/w#_adhd_processed_data/w#_adhd_Results_uncleaned.csv")
wave4 <- read.csv("./wave#/w#_adhd_processed_data/w#_adhd_Results_uncleaned.csv")
wave5 <- read.csv("./wave#/w#_adhd_processed_data/w#_adhd_Results_uncleaned.csv")
...
write_csv(dat2, "adhd_sst_all.csv")
